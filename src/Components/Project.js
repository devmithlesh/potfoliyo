                ...
                <div className="container mx-auto py-28 px-10 sm:pl-0 md:pl-80 lg:md:pl-80">
                    ...
                    <div className="grid grid-flow-cols grid-cols-1 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 gap-8 pt-10">
                        ...
                        <div>
                            ...
                            <a href="https://pensive-turing-10a23d.netlify.app" className="text-xs text-gray-300 border-p" target="_blank">Clone of Netflix Desigen</a>
                        </div>
                        <div>
                            <img src={img3} alt="Discord-design" className="bg-gray-200 py-1 px-1 img-box" />
                            <a href="https://frosty-rosalind-c7620e.netlify.app" className="text-xs text-gray-300 border-p" target="_blank">Clone of Discord Desigen</a>
                        </div>
                        <div>
                            <img src={img4} alt="linkdin" className="bg-gray-200 py-1 px-1 img-box" />
                            <a href="https://cranky-shockley-4144d7.netlify.app" className="text-xs text-gray-300 border-p" target="_blank">Clone of Linkedin Desigen</a>
                        </div>
                        <div>
